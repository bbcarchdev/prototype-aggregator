...
class TroveDecadesListPage extends TroveDateBrowser
{
	protected $class = 'http://projectreith.com/ns/Decade';
	
	protected function forwardToProxy($route, &$args)
	{
		if(!($obj = $this->model->objectForIri('urn:x-time:decade:' . $route)))
		{
