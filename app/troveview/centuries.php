...
class TroveCenturiesListPage extends TroveDateBrowser
{
	protected $class = 'http://projectreith.com/ns/Century';
	
	protected function forwardToProxy($route, &$args)
	{
		if(!($obj = $this->model->objectForIri('urn:x-time:century:' . $route)))
		{
